        ...
        <div class="card">
          <div class="card-body">
            <div class="form-inline">
                <div class="col-sm-6">
                    <h3 class="title-page">เพิ่มวงเงิน Pocket Money</h3>
                </div>
...
<script>
	function open_to_select_product(i_pera, amount)
	 {
		window.open("/payment_method/re_assign_pocket_money?i_pera="+i_pera+"&amount="+amount," _blank","height=100,width=450,status=yes,toolbar=no,menubar=no,location=no")
	 }
</script>
@push('plugin-scripts')
{!! Html::script('/js/search_payment_method.js') !!}
@endpush
...
@push('custom-scripts')
    <script>
        ...
        let data = {'page': 0};
        search_payment_method(data,'pocket_money_data');
        async function search_page(page = 0)
        {
            ...
            await search_payment_method(data,'pocket_money_data');
        }
