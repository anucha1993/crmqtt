...
<tr  style="print-color-adjust: exact; background:#011c47;">
<td style="padding:30px;">
<div class="text-center " id="title_header_delivery" style="font-size: 18px; font-weight: bold;padding-bottom:1rem"><font color=white size=+4>ใบส่งของ</font></div>
<div style="font-size: 16px;padding-bottom:1rem" class="text-center">
  <div style="font-weight: bold; display: inline-block;width: 30%;"><font color=white>Book No.</font></div>
  <div style="font-weight: bold;display: inline-block;width: 30%;"><font color=white>Billno</font></div>
  <div style="font-weight: bold;display: inline-block;width: 30%;"><font color=white>เลขที่ {{$orders->order_number}}</font></div>
</div>
</td>
</tr>
</table>
...
<div style="font-size: 16px;padding-bottom:1rem">
  ...
  <div style="font-weight: bold; display: inline-block;width: 60%;border-bottom: 1px dotted;" > 
...
<table style="font-size: 16px;width: 100%; border:1px solid black;" id="tableBilling">
  ...
  <tbody>
    ...
    <tr>
        ...
        <td style="font-weight: bold;"  class="text-right">{{($data->product_type_id == 1) ? number_format(($data->size_unit*$data->price_item*$data->item_send_qty),2) : number_format(($data->size_unit*0.35*$data->price_item*$data->item_send_qty),2)}}</td>
      </tr>
    @endforeach
...
<div style="font-size: 16px;padding-top: 1.5rem;">
  ...
  <div style="font-weight: bold; display: inline-block;float: right;">ลงชื่อ ........................................................... ผู้รับเงิน</div>
</div>
