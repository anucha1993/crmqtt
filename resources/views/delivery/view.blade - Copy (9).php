                    ...
                    <div class="form-inline">
                        <div class="col-sm-6">
                            <div class="form-inline ">
                                ...
                                <p class="col-sm-6 warning-text text-right">{{ ($orders->on_vat == 1  || $quotation->qo_on_vat == "Y") ? number_format($orders->vat,2) : '0.00'}}</p>
                        ...
                        <div class="col-sm-6">
                            <div class="form-inline left-border bottom-border">
                                ...
                                <p class="col-sm-6 warning-text text-right" id="vat_long">{{ ($orders->on_vat == 1  || $quotation->qo_on_vat == "Y") ? number_format($orders->vat,2) : '0.00'}}</p>
...
function toggle_add_new_location () {
	if (document.getElementById('delivery_location').disabled == true) {
		...
		document.getElementById('new_delivery_location_contact_person_phone_no').disabled = true;
				...
				<div class="row">
												<div class="col-sm-12">
														<label class="col-sm-6 header-title">หมายเหตุ ที่ 1 <input class="form-control form-control-sm" type="text" id=remark_1 name=remark_1  value="{{$data_for_remarks->remark_1}}"></label>
														<label class="col-sm-6 header-title">หมายเหตุ ที่ 2 <input class="form-control form-control-sm" type="text" id=remark_2 name=remark_2  value="{{$data_for_remarks->remark_2}}"></label>
														<label class="col-sm-6 header-title">หมายเหตุ ที่ 3 <input class="form-control form-control-sm" type="text" id=remark_3 name=remark_3  value="{{$data_for_remarks->remark_3}}"></label>
														<label class="col-sm-6 header-title">หมายเหตุ ที่ 4 <input class="form-control form-control-sm" type="text" id=remark_4 name=remark_4  value="{{$data_for_remarks->remark_4}}"></label>
														<label class="col-sm-6 header-title">หมายเหตุ ที่ 5 <input class="form-control form-control-sm" type="text" id=remark_5 name=remark_5  value="{{$data_for_remarks->remark_5}}"></label>
												</div>
											</div>
                <div class="row">
                    <div class="col-sm-12">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="d-flex flex-row justify-content-center align-items">
							...
							<button type="submit" id="render_price" name="render_price" value="Y" class="btn btn-primary btn-fw">ยืนยันทำรายการแบบ => แสดงราคา</button>
							<button type="submit" id="render_price" name="render_price" value="N" class="btn btn-primary btn-fw">ยืนยันทำรายการแบบ => ไม่แสดงราคา</button>
							<?php 
								$disabled = "";
								if ($check_if_already_added_for_payment_history_of_DED_flag == "Yes") {
									$disabled = "disabled";
								}
							?>
							<button type="button" {{$disabled}} onclick="add_payment_history_record(
