                        ...
                        <div class="row">
							...
							<div class="col-sm-12 form-inline">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="input-group col-sm-12">
                                        <input class="form-control" type="text" name="text_number_vat" id="text_number_vat" value="" maxlength="13" minlength ="13" placeholder="กรอกเลขประจำตัวผู้เสียภาษี..." onchange="search_text_vat(this.value)">
                                    </div>
                                </div>
                                <div class="col-sm-4">
                            ...
                            <div class="col-sm-12 form-inline">
                                ...
                                <div class="col-sm-4 form-inline padding-0">
                                    <div class="col-sm-6 padding-rifht-0">
                                        ...
                                        <div class="input-group col-sm-12">
                                            <input class="form-control" type="text"  name="fname" value="" placeholder="กรอกชื่อผู้ติดต่อ...">
                                        </div>
                                    </div>
                                    <div class="col-sm-6 padding-left-0">
                                        <label class="col-sm-12 title-input-customer"><br></label>
                                        <div class="input-group col-sm-12">
                                            <input class="form-control" type="text"  name="lname" value="" placeholder="กรอกนามสกุล...">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-4 form-inline padding-0">
                                    <div class="col-sm-6 padding-rifht-0">
                                        ...
                                        <div class="input-group col-sm-12">
                                            <input class="form-control" type="text"  name="customer_phone" max="10" min="10" value="" placeholder="กรอกเบอร์โทรศัพท์...">
                                        </div>
                                    </div>
                                    <div class="col-sm-6 padding-left-0">
                            ...
                            <div class="col-sm-12 form-inline">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="input-group col-sm-12">
                                        <input class="form-control" type="text"  name="customer_address" value="" placeholder="กรอกที่อยู่ร้านค้า บ้านเลขที่,ชื่ออาคาร,ซอย,ถนน...">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12 form-inline">
                                ...
                                <div class="col-sm-4 form-inline padding-0">
                                    <div class="col-sm-6 padding-rifht-0">
                                        ...
                                        <div class="input-group col-sm-12">
                                            <select name="province_code"  class="form-control" id="provinceselect"  onchange="selectprovince(this.value)">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="d-flex flex-row justify-content-center align-items">
                                ...
                                <button type="submit" id="submit" class="btn btn-primary btn-fw" onclick="alert('OK to create ร้านค้า');">ยืนยันทำรายการ</button>
                            </div>
                        </div>
                    </div>
                </form>
