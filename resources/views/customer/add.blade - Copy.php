                            ...
                            <div class="col-sm-12 form-inline">
                                ...
                                <div class="col-sm-4 form-inline padding-0">
                                    ...
                                    <div class="col-sm-6 padding-left-0">
                                        ...
                                        <div class="input-group col-sm-12">
                                            <input class="form-control" type="email" required name="customer_mail" id="customer_mail" onchange="search_customer_mail(this.value)" value="" placeholder="กรอกอีเมล...">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12 form-inline">
                                ...
                                <div class="col-sm-4 form-inline padding-0">
                                    ...
                                    <div class="col-sm-6 padding-left-0">
                                        ...
                                        <div class="input-group col-sm-12">
                                            <select name="amphoe_code" required class="form-control" id="amphoeselect" onchange="selectamphoe(this.value)">
                                                <option value="">-เลือก-</option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-4 form-inline padding-0">
                                    <div class="col-sm-6 padding-rifht-0">
                                        ...
                                        <div class="input-group col-sm-12">
                                            <select name="district_code" required class="form-control" id="districtselect" onchange="selectdistrict(this.options[this.selectedIndex].getAttribute('zipcode'))">
                                                <option value="">-เลือก-</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 padding-left-0">
                                        ...
                                        <div class="input-group col-sm-12">
                                            <input class="form-control" required type="text" name="zip_code" id="zip_code" value="" placeholder="กรอกรหัสไปรษณีย์...">
                                        </div>
                                    </div>
                                </div>
                            </div>
