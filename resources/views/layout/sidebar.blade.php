<nav class="sidebar sidebar-offcanvas dynamic-active-class-disabled" id="sidebar">
  <ul class="nav sidebar-nav">
    ...
    <li class="nav-item sidebar-nav-item orders-meun {{ active_class(['orders']) }} ">
      <a class="nav-link sidebar-nav-item" href="{{ url('orders/all') }}">
...
Pera add 
-->
	<li class="nav-item sidebar-nav-item barcode-meun {{ active_class(['customer/barcode']) }} ">
      <a class="nav-link sidebar-nav-item" href="{{ url('customer/barcode') }}">
        <i class="mdi mdi-store"></i>
        <label class="sidebar-title menu-title">บาร์โค๊ด</label>
      </a>
    </li>
	<li class="nav-item sidebar-nav-item products-meun {{ active_class(['products']) }} ">
      <a class="nav-link sidebar-nav-item" href="{{ url('products') }}">
        <i class="mdi mdi-store"></i>
        <label class="sidebar-title menu-title">รายการสินค้า</label>
      </a>
    </li>
<!--
Pera end 
-->
        ...
        <div class="collapse {{ show_class(['report/*']) }}" id="report_page">
          <ul class="nav flex-column sub-menu">
            ...
            <li class="nav-item sidebar-nav-item users-meun submenu {{ active_class(['report/orders']) }} ">
              <a class="nav-link sidebar-nav-item" href="{{ url('/pay/orders') }}">
                <label class="sidebar-submenu menu-title">รายงานยอดสั่งซื้อบิลหลัก</label>
                </a>
            </li>
			<li class="nav-item sidebar-nav-item users-meun submenu {{ active_class(['report/payment_history']) }} ">
              <a class="nav-link sidebar-nav-item" href="{{ url('/report/payment_history') }}">
                <label class="sidebar-submenu menu-title">รายงานประวัติการชำระเงิน</label>
                </a>
            </li>
	...
	<li class="nav-item {{ active_class(['payment_method/*']) }}">
        <a class="nav-link sidebar-nav-item {{ active_class(['payment_method/*']) }}" data-toggle="collapse" href="#report_page" aria-expanded="{{ is_active_route(['payment_method/*']) }}"  aria-controls="report_page">
            <i class="mdi mdi-file-document"></i>
            <label class="sidebar-title menu-title">Payment Method</label>
          <i class="menu-arrow"></i>
        </a>
        <div class="collapse {{ show_class(['payment_method/*']) }}" id="report_page">
          <ul class="nav flex-column sub-menu">
             <li class="nav-item sidebar-nav-item users-meun submenu {{ active_class(['payment_method/pocket_money']) }} ">
                <a class="nav-link sidebar-nav-item" href="{{ url('/payment_method/pocket_money') }}">
                  <label class="sidebar-submenu menu-title">Pocket Money</label>
                </a>
            </li> 
          </ul>
        </div>
