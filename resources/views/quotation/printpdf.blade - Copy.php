        ...
        <div class="row">
            <div class="col-lg-12 grid-margin-pdf">
                <div class="text-center">
                    ...
                    <div class="row">
                        <label class="text-right col-md-8 color-title title-page">วันที่</label>
                    ...
                    <div class="row">
                        ...
                        <label class="title-page text-left color-title col-md-2 text-right">ผู้ซื้อ/ผู้ติดต่อ </label>
                        <label class="title-page text-left color-title col-md-4">{{$customer->customer_name}} </label>

                    </div>
                    <div class="row">
                        {{-- <div class="col-md-1"></div> --}}
                        <label class="title-page text-left color-title col-md-2">ที่อยู่ </label>
