        ...
        <div class="card">
          <div class="card-body">
            ...
            <form id="createquotation" action="{{route('quotation.save')}}" method="POST">
				...
				<div class="form-row">
                    <div class="input-group col-sm-12 input-header">
                        <label class="col-sm-12 header-title">เบอร์โทรผู้ติดต่อหน้างาน <span class="red">*</span></label>
                        <div class="col-sm-12">
                            <input class="form-control form-control-sm" required type="text" name="contact_person_onsite_phone_no" id="contact_person_onsite_phone_no"  value="">
                        </div>
                    </div>
                </div>
                ...
                <table class="table table-width">
                    ...
                    <tr>
						...
						<th style="width: 100px;"> นน./unit/เมตร (Kgs.)</th>
						<th style="width: 100px;"> นน./รายการ(Kgs.)</th>
...
i = 0;
                    ...
                    <a class="btn btn-apped" onclick="i++; append.appendrow(i)"  >+ เพิ่มรายการ</a>
                </div>
                <div class="row">
...
// Pera end add 										
                                ...
                                html +='</td>'
                                html +='<td>'
                                    html +='<input type="text" name="weight_per_unit_pera['+iii+']" id="weight_per_unit_pera['+iii+']" value="" class="form-control form-control-sm text-right">'
                                html +=' </td>'
								html +='<td>'
                                    html +='<input type="text" name="weight_sub_total_pera['+iii+']" id="weight_sub_total_pera['+iii+']" value="" class="form-control form-control-sm text-right">'
									html +='<input type="hidden" name="product_id['+iii+']" id="product_id['+iii+']" value="" class="form-control form-control-sm text-right">'
                                html +=' </td>'
								html +='<td>'
