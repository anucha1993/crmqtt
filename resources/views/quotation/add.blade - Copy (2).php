          ...
          <div class="card-body">
            ...
            <form id="createquotation" action="{{route('quotation.save')}}" method="POST">
                ...
                <div class="col-sm-12 m-t-15">
                    <a class="btn btn-apped" onclick="append.appendrow()"  >+ เพิ่มรายการ</a>
                </div>
                <div class="row">
...
// Pera end add 										
                                ...
                                html +='<td style="width:8%">'
                                    html +='<input type="text" name="size_unit[]" disabled value="" data-type="number" class="form-control form-control-sm size_unit_'+newid+'" required  onkeyup="append.summoney('+newid+')">'
