                            ...
                            <tr class="column" id="row_{{$key+1}}" data-id="{{$key+1}}">
                                ...
                                <td>
									...
									<select name="pera[]" class="form-control form-control-sm" required>
										<option value="ลวด 4" {{$selected_1_4}}>-ลวด 4-</option>
										<option value="ลวด 5" {{$selected_1_5}}>-ลวด 5-</option>
										<option value="ลวด 6" {{$selected_1_6}}>-ลวด 6-</option>
										<option value="ลวด 7" {{$selected_1_7}}>-ลวด 7-</option>
                                    </select> 
									<?php 
										$selected_2_1 = "";
										$selected_2_2 = "";
									...
									?>
									<select name="pera_2[]" class="form-control form-control-sm" required>
