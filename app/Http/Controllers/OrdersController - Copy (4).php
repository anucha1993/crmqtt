...
class OrdersController extends Controller
{
    ...
    public function view($id)
    {
		...
		if (($check_if_already_added_for_payment_history_of_OTP != NULL) or ($check_if_already_updated_for_payment_method_of_order != NULL)) {
