...
class QuotationController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        // {
            ...
            $query = Quotation::select(
                ...
                DB::raw("case when quotation.customer_type = 'customer' then CONCAT(master_customer.customer_address,' ตำบล ',master_district.district_name,' อำเภอ ',master_amphoe.amphoe_name,' จังหวัด ',master_province.province_name,' ',master_customer.zip_code) else customer_other.customer_address end AS customer_address"),
	...
	public function list_products(Request $request)
    {
		...
		$datas = $query->get();
        return view('quotation.list_products',compact('i','datas'));
		#return $datas;
    }
...
// Pera adds
		...
		$arrayAddDeliveryLocation['onsite_contact_phone_no'] = $request->onsite_contact_phone_no;
...
// End Pera's add, end locking table
        ...
        foreach($request->product_name as $key => $product_name)
        {
			...
			$arrayAddOrderItem['product_id'] = $request->product_id[$key];
    ...
    public function view($id)
    {
		...
		#return $quotation->customer_type;
