...
class DeliveryController extends Controller
{
    ...
    public function add($id)
    {
        ...
        return view('delivery.add',compact('breadcrumb','orders','i','datas','order_delivery_number','orderdelivery','paymentcount','orders_pera','delivery_location','location_name'));
    ...
    public function view($id, $id_pdf = null)
    {
        ...
        return view('delivery.view',compact('breadcrumb','i','datas','datas_sub_total_delivery','orders','deliverys','customer','location_name','delivery_location'));
        // }
    ...
    {
        // dd(property_exists($request->all(), $request->status));
        // $request->status = $request->status_text;
        // $request->date_send = $request->date_send_text_datepicker;
        // $request->status_payment = $request->status_payment_text;

        // dd($request->status,$request->date_send,$request->status_payment);
