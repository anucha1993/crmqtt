...
class DeliveryController extends Controller
{
    ...
    public function view($id, $id_pdf = null)
    {
		...
		$check_if_already_added_for_payment_history_flag = "No";	
		
		if ($check_if_already_added_for_payment_history != NULL) {
			$check_if_already_added_for_payment_history_flag = "Yes";
		}
        ...
        return view('delivery.view',compact('quotation','check_if_already_added_for_payment_history_flag','breadcrumb','data_for_remarks','location_contact_person_name','location_contact_person_phone_no','i','datas','datas_sub_total_delivery','orders','deliverys','customer','location_name','delivery_location'));
        // }
