...
class DeliveryController extends Controller
{
    public function list($id)
    {
        ...
        ->where('order_delivery.order_id',$id)->orderby('order_delivery.created_at','asc')->get();
    ...
    public function view($id, $id_pdf = null)
    {
	    ...
	    $check_if_already_added_for_payment_history_of_DED =  PaymentHistory::select('*')
				...
				//->where('orders.id','order_delivery.order_id')
				->where('payment_history.order_delivery_id',$id)
				->first();
		//return $check_if_already_added_for_payment_history_of_DED->toSql();
		$check_if_already_added_for_payment_history_of_DED_flag = "No";	
		
		if ($check_if_already_added_for_payment_history_of_DED != NULL) {
			$check_if_already_added_for_payment_history_of_DED_flag = "Yes";
		}
        ...
        return view('delivery.view',compact('quotation','check_if_already_added_for_payment_history_of_DED_flag','breadcrumb','data_for_remarks','location_contact_person_name','location_contact_person_phone_no','i','datas','datas_sub_total_delivery','orders','deliverys','customer','location_name','delivery_location'));
        // }
